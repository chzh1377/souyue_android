...
public class RequestQueue {
     ...
     * any dispatcher.
     */
    protected final Set<Request<?>> mCurrentRequests = new HashSet<Request<?>>();
    ...
    protected List<RequestFinishedListener> mFinishedListeners =
