...
public abstract class ZSAsyncTask<Params, Progress, Result> {
	 ...
	 */
	public static final Executor THREAD_POOL_EXECUTOR = (ExecutorService) Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors() * 2 + 1);
	 ...
	 */
	public final ZSAsyncTask<Params, Progress, Result> execute(Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final ZSAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		final ZSAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(ZSAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
