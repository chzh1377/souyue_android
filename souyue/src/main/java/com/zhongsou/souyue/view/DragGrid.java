...
//    private Vibrator mVibrator;
     ...
     * 开始拖拽和结束拖拽的监听
     */
    private OnChangeListener startChangeListener;
    private OnChangeListener stopChangerListener;
...
//                .getSystemService(Context.VIBRATOR_SERVICE);
        // 将布局文件中设置的间距dip转为px
        mHorizontalSpacing = DeviceUtil.dip2px(context, mHorizontalSpacing);
    }

    public void setStartChangeListener(OnChangeListener listener){
        this.startChangeListener = listener;
    }

    public void setStopChangeListener(OnChangeListener listener){
        this.stopChangerListener = listener;
    }
...
//                    mVibrator.vibrate(50);// 设置震动时间
    ...
    public void startDrag(Bitmap dragBitmap, int x, int y) {
        stopDrag();
        if(startChangeListener != null){
            startChangeListener.onChange(null);
        }
    ...
    private void stopDrag() {
        ...
        if(stopChangerListener != null){
            stopChangerListener.onChange(null);
        }
    }
