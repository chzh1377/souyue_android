 ...
 * @data: 2016/3/16.
 */
public class ZSVideoMediaController extends FrameLayout implements
    ...
    public ZSVideoMediaController(Context context) {
        super(context);
        initView(context);
    }

    public ZSVideoMediaController(Context context, AttributeSet attrs,
                                int defStyleAttr) {
