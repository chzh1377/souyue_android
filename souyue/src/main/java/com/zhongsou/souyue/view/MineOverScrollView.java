...
/**
 * 我的，滑动回弹效果
 * Created by qubian on 2015/11/19.
 */
public class MineOverScrollView  extends FrameLayout implements View.OnTouchListener
{
    ...
    public MineOverScrollView(Context context, AttributeSet attrs)
    {

        this(context, attrs, 0);
    }

    public MineOverScrollView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    private boolean overScrollView()
    {
        ...
        else if (currScrollY + displayHeight > contentBottom- DeviceUtil.dip2px(mContext, 205))
        {
            // Scroll to content top
            ...
            else
            {
                ...
                scrollBy = contentBottom - displayHeight - currScrollY-DeviceUtil.dip2px(mContext, 205);
    ...
    public void forceRefresh(){
        mScroller.startScroll(0, 1500, 0, -160, 200);
        //Log.d(TAG, "start:" + getScrollY());
        isInFlingMode = false;
    }


    public void completeForceRefresh(){
        //Log.d(TAG, "end:" + getScrollY());
        mScroller.startScroll(0, 1340, 0, 160, 1000);
    }
