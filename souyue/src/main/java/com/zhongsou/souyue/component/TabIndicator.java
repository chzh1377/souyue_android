...
//        bage.setBadgeBackgroundColor(getResources().getColor(R.color.im_count_number_back));
        // bage.setBadgePosition(BadgeView.POSITION_TOP_RIGHT);
        bage.setTextSize(12);
        bage.setMaxEms(3);
        bage.setSingleLine(true);
        bage.setBadgeMargin(((Utils.getScreenWidth(context) / 4 - DeviceUtil
                .dip2px(context, 50)) / 2), 5);
        bage.hide();
