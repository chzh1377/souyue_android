...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.zhongsou.souyue.ent.bitmap.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                try {
                    ...
                    android.util.Log.w(LOG_TAG, "An error occured while executing doInBackground(), " + e.getCause());
     ...
     *         {@link com.zhongsou.souyue.ent.bitmap.AsyncTask.Status#RUNNING} or {@link com.zhongsou.souyue.ent.bitmap.AsyncTask.Status#FINISHED}.
     *
