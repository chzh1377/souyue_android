...
public class LinearLayoutForListView extends LinearLayout {
    ...
    private void initWithStyle(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LinearLayoutForListView);
        divider = a.getResourceId(R.styleable.LinearLayoutForListView_divider,R.drawable.listview_divider);            // <!-- format="color|reference" 如果写两个的话，代码里写getDrawable -->
        divideHeight = (int) a.getDimension(R.styleable.ExpandLinearLayout_divideHeight, 1f);
        itemSelector = a.getResourceId(R.styleable.LinearLayoutForListView_itemSelector, R.drawable.circle_list_item_selector);
        a.recycle();
    }
