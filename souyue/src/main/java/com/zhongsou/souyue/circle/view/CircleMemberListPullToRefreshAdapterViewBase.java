...
public abstract class CircleMemberListPullToRefreshAdapterViewBase<T extends AbsListView> extends CircleMemberListPullToRefreshBase<T> implements
		OnScrollListener {
	...
	public CircleMemberListPullToRefreshAdapterViewBase(Context context, int mode) {
		super(context, mode);
		refreshableView.setOnScrollListener(this);
	}

	public CircleMemberListPullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		refreshableView.setOnScrollListener(this);
	}
	...
	public final void setEmptyView(View newEmptyView) {
		...
		if (refreshableView instanceof CircleMemberListEmptyViewMethodAccessor) {
			((CircleMemberListEmptyViewMethodAccessor) refreshableView).setEmptyViewInternal(newEmptyView);
		} else {
