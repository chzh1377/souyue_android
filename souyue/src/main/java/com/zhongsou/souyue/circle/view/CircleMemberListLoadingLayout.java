...
public class CircleMemberListLoadingLayout extends FrameLayout {
	...
	public CircleMemberListLoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
		super(context);
		ViewGroup header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.circle_member_list_pull_to_refresh_header, this);
		...
		switch (mode) {
			case CircleMemberListPullToRefreshBase.MODE_PULL_UP_TO_REFRESH:
				headerImage.setImageResource(R.drawable.circle_member_list_pulltorefresh_up_arrow);
				break;
			case CircleMemberListPullToRefreshBase.MODE_PULL_DOWN_TO_REFRESH:
			default:
				headerImage.setImageResource(R.drawable.circle_member_list_pulltorefresh_down_arrow);
				break;
		}
	}
