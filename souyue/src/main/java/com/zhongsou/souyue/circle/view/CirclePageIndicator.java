...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		final int defaultPageColor = res
				.getColor(R.color.circle_default_circle_indicator_page_color);
		final int defaultFillColor = res
				.getColor(R.color.circle_default_circle_indicator_fill_color);
		...
		final int defaultStrokeColor = res
				.getColor(R.color.circle_default_circle_indicator_stroke_color);
		...
		final boolean defaultCentered = res
				.getBoolean(R.bool.circle_default_circle_indicator_centered);
		final boolean defaultSnap = res
				.getBoolean(R.bool.circle_default_circle_indicator_snap);
