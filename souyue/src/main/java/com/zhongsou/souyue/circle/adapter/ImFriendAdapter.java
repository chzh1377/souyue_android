...
public class ImFriendAdapter extends BaseAdapter implements AlphaIndexer {
    ...
    private OnDeleteListener deleteListener = new OnDeleteListener() {
        ...
        public void onDeleteItem(int position) {
            final Contact contactDel = ImFriendAdapter.this.data.remove(position);
    ...
    public ImFriendAdapter(ListView listView, Context context, Map<String, Integer> alphaIndex, int rightWidth) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (type == VIEW_TYPE_VALUE) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = inflateView(R.layout.circle_im_friend_list_view_row, parent);
