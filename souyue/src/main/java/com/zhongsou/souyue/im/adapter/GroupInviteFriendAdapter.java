...
public class GroupInviteFriendAdapter extends BaseAdapter implements AlphaIndexer {
    ...
    private OnDeleteListener deleteListener = new OnDeleteListener() {
        ...
        public void onDeleteItem(int position) {
            final Contact contactDel = GroupInviteFriendAdapter.this.data.remove(position);
    ...
    public GroupInviteFriendAdapter(ListView listView, Context context, Map<String, Integer> alphaIndex, int rightWidth) {
 ...
 */
            ...
            if(selected.get(item.getChat_id())!=null && selected.get(item.getChat_id())) {
                ...
                holder.checkBox.setChecked(true);
//                    holder.item_left.setBackgroundResource(R.color.discover_bg);
                ...
                holder.checkBox.setChecked(false);
                holder.checkBox.setBackgroundResource(R.drawable.radiobutton);
//                    holder.item_left.setBackgroundResource(R.drawable.im_item_selector);
            }
//            if(selected.get(item.getChat_id())!=null && selected.get(item.getChat_id())) {
//            	holder.checkBox.setChecked(true);
//            } else {
