...
public class ImInviteDialog extends Dialog {
    ...
    public ImInviteDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        private ImInviteDialogInterface positiveButtonClickListener, negativeButtonClickListener;
         ...
         * @return
         */
        public Builder setPositiveButton(int positiveButtonText, ImInviteDialogInterface listener) {
         ...
         * @return
         */
        public Builder setPositiveButton(String positiveButtonText, ImInviteDialogInterface listener) {
         ...
         * @return
         */
        public Builder setNegativeButton(int negativeButtonText, ImInviteDialogInterface listener) {
         ...
         * @return
         */
        public Builder setNegativeButton(String negativeButtonText, ImInviteDialogInterface listener) {
        ...
        public ImInviteDialog create() {
            ...
            final ImInviteDialog dialog = new ImInviteDialog(context, R.style.im_share_dialog);
            View layout = inflater.inflate(R.layout.im_invite_dialog, null);
