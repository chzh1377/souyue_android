...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    private AbstractLoadingLayout mHeaderLoadingView;
    ...
    public void onUpdateTime(String text) {
        super.onUpdateTime(text);
        if (null != mHeaderLoadingView){
            if(text == null){
                text = "刚刚";
                mHeaderLoadingView.setRefreshTime("最后刷新时间：" + text);
            }else {
                if ("".equals(text))
                    mHeaderLoadingView.setRefreshTime("");
                else
                    mHeaderLoadingView.setRefreshTime("最后刷新时间：" + text);
            }
        }
    ...
    public void setTimeLabel(String text){
        ...
        if (null != mHeaderLoadingView){
            if(text == null){
                text = "正在刷新获取数据";
                mHeaderLoadingView.setRefreshTime(text);
            }else {
                if ("".equals(text))
                    mHeaderLoadingView.setRefreshTime("正在刷新获取数据");
                else
                    mHeaderLoadingView.setRefreshTime("最后刷新时间：" + text);
            }
        }
...
//        if(isfirst){
//            mHeaderLoadingView = createNewYearLoadingLayout(context, Mode.PULL_DOWN_TO_REFRESH, a);
//        }else{
...
//        lv.setDividerHeight(2);
    ...
    protected void resetHeader() {
        ...
        AbstractLoadingLayout originalLoadingLayout;
        AbstractLoadingLayout listViewLoadingLayout;
...
//                if(isfirst){
//                    listViewLoadingLayout = newYearHeaderLoadingView;
//                }else{
...
//                }
    ...
    protected void setRefreshingInternal(boolean doScroll) {
        ...
        final AbstractLoadingLayout originalLoadingLayout;
        AbstractLoadingLayout listViewLoadingLayout;
