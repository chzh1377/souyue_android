 ...
 */
public class CheckTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    /**
...
//			final int newSelected = tabView.getIndex();
    ...
    public CheckTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
