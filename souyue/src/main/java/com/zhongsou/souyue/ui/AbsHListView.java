...
import com.zhongsou.souyue.ui.ViewHelperFactory.ViewHelper;
...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
    ...
    private void initAbsListView(Context context) {
        /**
         * 自己计算mOverflingDistance mOverscrollDistance数值 
         * 防止android2.2不支持
         */
        ...
        if (isLayoutSizeAtLeast(SCREENLAYOUT_SIZE_XLARGE)) {
    ...
    public boolean performItemClick(View view, int position, long id) {
        ...
        if (mChoiceMode != ListView.CHOICE_MODE_NONE) {
            ...
            if (mChoiceMode == ListView.CHOICE_MODE_MULTIPLE
                ...
                //防止2.2报错
                if (mChoiceActionMode != null && android.os.Build.VERSION.SDK_INT >= 11) {
