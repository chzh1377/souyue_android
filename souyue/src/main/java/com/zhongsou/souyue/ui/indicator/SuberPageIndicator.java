...
import com.zhongsou.souyue.activity.SubscribeListActivity.TabPagerAdapter;
 ...
 */
public class SuberPageIndicator extends HorizontalScrollView implements
		PageIndicator {
	...
	public SuberPageIndicator(Context context) {
		this(context, null);
	}

	public SuberPageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		//5.05更新，调整高度
		mTabLayout.setDividerDrawable(new ColorDrawable(Color.TRANSPARENT));
		addView(mTabLayout, new ViewGroup.LayoutParams(MATCH_PARENT,
				(int) getResources().getDimension(R.dimen.space_35)));
	}
	...
	private class TabView extends TextView {
		...
		@SuppressLint("NewApi") public TabView(Context context) {
			super(context, null, R.attr.vpiTabPageIndicatorStyle);
			this.setGravity(Gravity.CENTER_HORIZONTAL);
			this.setLayoutDirection(TEXT_DIRECTION_INHERIT);
		}
