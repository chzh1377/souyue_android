...
import com.zhongsou.souyue.ui.lib.SlidingMenu.OnClosedListener;
import com.zhongsou.souyue.ui.lib.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        //System.out.println(System.currentTimeMillis()+"startscroll");
...
//		Log.v("FAN", "thisTouchAllowed x="+ev.getX()+";scrollx="+mScrollX);
...
//			Log.v(TAG, "onInterceptTouchEvent return " + mIsBeingDragged);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        mVelocityTracker.addMovement(ev);
        if (DEBUG)
            Log.v(TAG, "onTouchEvent action=" + action + ";mIsBeingDragged=" + mIsBeingDragged);
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                if (DEBUG)
                    Log.v(TAG, "onTouchEvent Received ACTION_DOWN");
            /*
            ...
            case MotionEvent.ACTION_MOVE:
                if (!mIsBeingDragged) {
                    ...
                    final float yDiff = Math.abs(y - mLastMotionY);
                    if (DEBUG)
                        Log.v(TAG, "onTouch moved to:(" + x + ", " + y + "), diff:(" + xDiff + ", " + yDiff + "), mLastMotionX:" + mLastMotionX);
                    if (xDiff > mTouchSlop && xDiff > yDiff && thisSlideAllowed(dx)) {
...
//		Log.v("FAN", "----------scrollTo" + mSelectorDrawable);
        super.scrollTo(x, y);
        mScrollX = x;
        if (mEnabled)
