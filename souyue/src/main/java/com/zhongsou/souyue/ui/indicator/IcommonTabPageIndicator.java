 ...
 */
public class IcommonTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    /**
...
//            }
    ...
    public IcommonTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        setHorizontalScrollBarEnabled(false);

        mTabLayout = new LinearLayout(getContext());

        mTabLayout.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
    ...
    private void animateToTab(final int position, int total) {
...
//        tv.setTextSize(16);
//        tv.setMaxLines(1);
////		tv.setWidth(dip2px(this.getContext(), 85));
//        tv.setTextColor(0xff4a4a4a);
//    }
//
