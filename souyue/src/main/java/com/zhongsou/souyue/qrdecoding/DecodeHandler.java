...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(ScaningActivity activity, Hashtable<DecodeHintType, Object> hints) {
...
//          Log.d(TAG, "rawResult"+rawResult);
        if (rawResult != null && CMainHttp.getInstance().isNetworkAvailable(activity)) {
            ...
            Message message = Message.obtain(activity.getHandler(), R.id.decode_failed);//R.id.decode_failed = 2
            message.sendToTarget();
        }
    }
