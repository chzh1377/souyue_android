...
//import com.zhongsou.souyue.pay.Constant.AlixDefine;
...
////
////
////			mProgress = showProgress(mContext, null, "正在检测安全支付服务版本",
////					false, true);
////
////			// 实例新线程检测是否有新版本进行下载
...
////        //
////        // 捆绑安装
////        retrieveApkFromAssets(mContext, Constant.ALIPAY_PLUGIN_NAME, cachePath);
////        showInstallConfirmDialog(mContext, cachePath, callback);
////    }
//
//	/**
//	 * 显示确认安装的提示
...
//			final String cachePath, final InstallCallback callback) {
...
//				showInstallConfirmDialog(mContext, cachePath, new InstallCallback() {
//                    @Override
//                    public void callBack() {
//                    }
//                });
