...
public class MsgUserPushHistoryListAdapter extends BaseAdapter {

	private List<Notice> news;
	private Context context;


	public MsgUserPushHistoryListAdapter(Context context, List<Notice> news) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tv_nick = (TextView) view
					.findViewById(R.id.tv_msgpush_history_item_nick);
